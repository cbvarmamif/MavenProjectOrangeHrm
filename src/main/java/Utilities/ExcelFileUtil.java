...
public class ExcelFileUtil 
{
 Workbook wb;
	 ...
	 {
		FileInputStream fis = new FileInputStream("E:\\selenium programs\\MavenProjectOrangeHrm\\TestInputs\\InputSheet.xlsx");
	 ...
	 public void setData(String sheetname,int row,int column,String status) throws Throwable 
	 {
		 ...
		 FileOutputStream fos = new FileOutputStream("E:\\selenium programs\\MavenProjectOrangeHrm\\TestOutput\\TestOutput.xlsx"); 
		 wb.write(fos);
		 fos.close();		 
	 }
